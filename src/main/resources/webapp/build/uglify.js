...
(function(exports, global) {
    ...
    (function() {
        ...
        DEFPRINT(AST_Number, function(self, output) {
            if (self.literal !== undefined && +self.literal === self.value && self.scope && self.scope.has_directive("use asm")) {
...
Object.makeDeepCopy = function(src) {
    if (src instanceof Array) {
        var a = [], i = src.length;
        while (--i >= 0) a[i] = Object.makeDeepCopy(src[i]);
        return a;
    }
    ...
    if (src instanceof Object) {
        var i, dest = {};
        for (i in src) dest[i] = Object.makeDeepCopy(src[i]);
        return dest;
    }
    return src;
};
...
function compile(filename, files, options) {
    ...
    for (var i = 0; i < files.length; i++) {
        ast = UglifyJS.parse(files[i].content, {
